    ...
    <div className={sty.container}>
      ...
      >
        <div className={sty.topText}>
          ...
          <span>
          공해, 미세먼지, 황사, 분진등의 만연한 오염환경에서 백신이나 항생제의 처방으로는 한계에 이른 현실에서,
          </span>
        </div>

        <div className={sty.midBorder}></div>
          <div className={sty.bottomText}>
          Greetings
          </div>
        </div>
      <div
      className={sty.contentContainer}
      >
        <div
        className={sty.flex1}
        >
